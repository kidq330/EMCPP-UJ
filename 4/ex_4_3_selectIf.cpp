...
template <template <typename, typename> typename OutContainer, typename T,
          typename Alloc, template <typename, typename> typename InContainer,
          typename Predicate>
OutContainer<T, Alloc> selectIf(InContainer<T, Alloc> c, Predicate p) {
  OutContainer<T, Alloc> res;
